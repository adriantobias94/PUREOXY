...
//****************************************************************************************
require 'path.php';
init_cobalt('View from module');

$page_title       = 'ListView: %%';
$db_subclass      = 'from_module';
$html_subclass    = 'from_module_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add from module';
$edit_link        = 'Edit from module';
$delete_link      = 'Delete from module';
$view_link        = 'View from module';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_from_module.php';
$edit_page        = 'edit_from_module.php';
$delete_page      = 'delete_from_module.php';
$view_page        = 'detailview_from_module.php';
$csv_page         = 'csv_from_module.php';
$report_page      = 'reporter_from_module.php';
