...
//****************************************************************************************
require 'path.php';
init_cobalt('View air data');

$page_title       = 'ListView: %%';
$db_subclass      = 'air_data';
$html_subclass    = 'air_data_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add air data';
$edit_link        = 'Edit air data';
$delete_link      = 'Delete air data';
$view_link        = 'View air data';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_air_data.php';
$edit_page        = 'edit_air_data.php';
$delete_page      = 'delete_air_data.php';
$view_page        = 'detailview_air_data.php';
$csv_page         = 'csv_air_data.php';
$report_page      = 'reporter_air_data.php';
