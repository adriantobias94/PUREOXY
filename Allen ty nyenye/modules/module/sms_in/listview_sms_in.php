...
//****************************************************************************************
require 'path.php';
init_cobalt('View sms in');

$page_title       = 'ListView: %%';
$db_subclass      = 'sms_in';
$html_subclass    = 'sms_in_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add sms in';
$edit_link        = 'Edit sms in';
$delete_link      = 'Delete sms in';
$view_link        = 'View sms in';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_sms_in.php';
$edit_page        = 'edit_sms_in.php';
$delete_page      = 'delete_sms_in.php';
$view_page        = 'detailview_sms_in.php';
$csv_page         = 'csv_sms_in.php';
$report_page      = 'reporter_sms_in.php';
