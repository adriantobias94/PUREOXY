...
$page_title       = 'ListView: %%';
$db_subclass      = 'module';
$html_subclass    = 'module_html';
$arr_pkey_name    = array('id');
$results_per_page = LISTVIEW_RESULTS_PER_PAGE;

//user links / passport tags
$add_link         = 'Add module';
$edit_link        = 'Edit module';
$delete_link      = 'Delete module';
$view_link        = 'View module';

//pages - set to empty if you don't want to include them in the listview
$add_page         = 'add_module.php';
$edit_page        = 'edit_module.php';
$delete_page      = 'delete_module.php';
$view_page        = 'detailview_module.php';
$csv_page         = 'csv_module.php';
$report_page      = 'reporter_module.php';
